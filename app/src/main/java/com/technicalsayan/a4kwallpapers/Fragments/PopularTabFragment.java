...
public class PopularTabFragment extends Fragment {
 ...
 public PopularTabFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rcv = view.findViewById(R.id.rc_view_popular);

        FirebaseRecyclerOptions<Model> options =
                new FirebaseRecyclerOptions.Builder<Model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("image-data").orderByChild("popularity").limitToLast(51), Model.class)
                        .build();
